...
description: Find design smells in a breadboard and fix them. Applies the naming test and wiring verification to existing breadboards built with the breadboarding skill.
---
